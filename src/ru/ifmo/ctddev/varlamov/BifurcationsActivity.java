...
public class BifurcationsActivity extends Activity {
    ...
    private static final double START_X = 2.9;
    private static final double END_X = 3.8;
    private static final int MAX_LIMITS_SIZE = 256;
        ...
        protected Void doInBackground(Void... params) {
            for (int i = 0; i < PARTITION; i++) {
                ...
                for (int j = 0; j < points.size(); j++) {
                    ...
                    GraphViewSeries series = new GraphViewSeries("", new GraphViewSeries.GraphViewSeriesStyle(Color.rgb(0, 255, 0), 1), data);
